...
!(function () {
  ...
  function e(a, b, c, d) {
    ...
    (h.font = p + " " + b),
      ...
      h.fillText("E", 0, 0);
    for (
      var i = h.getImageData(Math.ceil(g.width / 2), 0, 1, g.height),
        j = null,
        k = g.height - 1;
      k >= 0;
      k--
  ...
  function f(a, f) {
    ...
    try {
      g.capHeightRatio = e(h, f, j.offsetWidth, o);
    } catch (a) {
      throw new Error(
        "[dropcap.js] Error computing font metrics: " + a.message
      );
    } finally {
      d(h);
    }
  ...
  function i(a) {
    var b = "gjpqQ";
    return b.indexOf(a.textContent) !== -1;
  }
  function j(a) {
    a.dcapjs &&
      ((a.style.cssFloat = ""),
  ...
  function k(b, c, d) {
    ...
    (k.dcapjs = !0),
      ...
      (k.style.padding = q),
      (k.style.fontSize = g(v)),
      (k.style.lineHeight = q);
    var w = s.leading / 2 + t;
    ...
    var y = 0;
    i(k) ? (y = v * (1 - o.baselineRatio)) : h(k) && (y = v - u),
      (k.style.height = g(u + y));
    var z = k.dcapjsStrut;
    z ||
...
window.Dropcap.layout(dropcaps, 2, 1);
